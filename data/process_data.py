...
def clean_data(df):
    ...
    # drop duplicates based on id since the variable is supposed to be unique
    df.drop_duplicates(subset=['id'], inplace=True)
    
    # change the data in related with value 2, should only be either 0 or 1
